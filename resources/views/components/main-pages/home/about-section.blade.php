...
<section class="about-section-two style-two layout-pt-60 layout-pb-60">
    <div class="auto-container">
        <div class="row justify-content-between align-items-center">
            ...
            <!-- Content Column -->
            <div class="content-column mb-5 col-xl-5 col-lg-6 col-md-12 col-sm-12">
            ...
            <div class="content-column mb-0 col-xl-5 col-lg-6 col-md-12 col-sm-12">
                <div class="wow fadeInLeft">
                    <div class="sec-title">
                        ...
                        <ul class="list-style-four mt-30">
                            <li>To connect talented professionals from around the world with exciting job opportunities all around the world.</li>
                            <li>To provide comprehensive and personalized support for relocating and settling in.</li>
                            <li>To empower individuals to build fulfilling lives in their new home.
                            </li>
                          </ul>
                    </div>
                </div>
