            ...
            <div class="row mb-60">
                <div
                    ...
                    <div class="section-title1">
                        <p class="font-weight-bold bx-font-size-16">We are a one-stop solution for foreigners seeking exciting career prospects and a fulfilling life in the heart of Europe. Our comprehensive platform connects you with job opportunities, assists with visa and residence permit applications, and provides essential support services to ensure a smooth transition to your new home.</p>
                    </div>
            ...
            <div class="row mb-60">
                <div
                    ...
                    <div class="section-title1">
                        ...
                        <p>To choose your trending job dream & to make
                            future bright.</p>
                    </div>
                    <div class="explore-btn">
                        <a href="job-listing1.html">Explore More <span><img
                        ...
                        <div class="company-area">
                            ...
                            <div class="company-details">
                                <div class="name-location">
                                    <h5><a href="job-details.html">React JS
                                            Developer</a></h5>
                            ...
                            <ul>
                                ...
                                <li>
                                    <img
                                        ...
                                        alt
                                    >
                                    <p><span class="title">Vacancy:</span>
                                ...
                                <li>
                                    <img
                                        ...
                                        alt
                                    >
                                    <p><span class="title">Deadline:</span>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="feature-card">
                        <div class="company-area">
                            ...
                            <div class="company-details">
                                <div class="name-location">
                                    <h5><a href="job-details.html">Assistant
                                            Laboratorist</a></h5>
                                    <p>Full Time, Part Time</p>
                                </div>
                                <div class="bookmark">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="feature-card">
                        <div class="company-area">
                            ...
                            <div class="company-details">
                                <div class="name-location">
                                    <h5><a href="job-details.html">Senior
                                            Receptionist</a></h5>
                                    <p>Full Time, Part Time</p>
                                </div>
                                <div class="bookmark">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="feature-card">
                        <div class="company-area">
                            ...
                            <div class="company-details">
                                <div class="name-location">
                                    <h5><a href="job-details.html">Manager
                                            (HR)</a></h5>
                                    <p>Full Time, Part Time</p>
                                </div>
                                <div class="bookmark">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="feature-card">
                        <div class="company-area">
                            ...
                            <div class="company-details">
                                <div class="name-location">
                                    <h5><a href="job-details.html">UI/UX
                                            Designer</a></h5>
                                    <p>Full Time, Part Time</p>
                                </div>
                                <div class="bookmark">
            ...
            <div class="row g-lg-4 gy-5 justify-content-center">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="single-work-process one text-center">
                        <div class="icon">
                            <img
                                src="/assets/images/icon/account-create.svg"
                                alt
                            >
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="single-work-process two text-center">
                        <div class="icon">
                            <img
                                src="/assets/images/icon/create-resume.svg"
                                alt
                            >
                        </div>
                        <div class="work-content">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="single-work-process one text-center">
                        <div class="icon">
                            <img
                                src="/assets/images/icon/job-find.svg"
                                alt
                            >
                        </div>
                        <div class="work-content">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="single-work-process two text-center">
                        <div class="icon">
                            <img
                                src="/assets/images/icon/job-apply.svg"
                                alt
                            >
                        </div>
                        <div class="work-content">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-card">
                                <div class="author-img">
                                    ...
                                    <div class="quat-icon">
                                        <img
                                            src="/assets/images/icon/quat-icon.svg"
                                            alt
                                        >
                                    </div>
                                </div>
                                <div class="testimonial-content">
                                    ...
                                    <p>On the other hand, we denounce with
                                        to the righteous indignation and
                                        dislike the men who are so beguiled
                                        to demoralized by the charms of
                                        pleasure.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper trusted-company-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="company-logo">
                                    <img
                                        src="/assets/images/bg/company-logo/trusted-company-02.png"
                                        alt
                                    >
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="company-logo">
                                    <img
                                        src="/assets/images/bg/company-logo/trusted-company-03.png"
                                        alt
                                    >
                                </div>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <div class="company-logo">
                                    <img
                                        src="/assets/images/bg/company-logo/trusted-company-06.png"
                                        alt
                                    >
                                </div>
                            </div>
                        ...
                        <div class="slide-item">
                            <div class="recruters-card">
                                <div class="company-area">
                                    ...
                                    <div class="name-location">
                                        <h5><a href="company-listing1.html">Norland
                                                Company</a></h5>
                                        <p><img
                                                src="/assets/images/icon/location.svg"
                                                alt
                        ...
                        <div class="slide-item">
                            <div class="recruters-card">
                                <div class="company-area">
                                    ...
                                    <div class="name-location">
                                        <h5><a href="company-listing1.html">Germaine
                                                Company</a></h5>
                                        <p><img
                                                src="/assets/images/icon/location.svg"
                                                alt
                        ...
                        <div class="slide-item">
                            <div class="recruters-card">
                                <div class="company-area">
                                    ...
                                    <div class="name-location">
                                        <h5><a href="company-listing1.html">Techman
                                                Digita</a></h5>
                                        <p><img
                                                src="/assets/images/icon/location.svg"
                                                alt
                        ...
                        <div class="slide-item">
                            <div class="recruters-card">
                                <div class="company-area">
                                    ...
                                    <div class="name-location">
                                        <h5><a href="company-listing1.html">Tario.Co
                                                Ltd</a></h5>
                                        <p><img
                                                src="/assets/images/icon/location.svg"
                                                alt
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="recent-article-wrap">
                        ...
                        <div class="recent-article-content">
                            ...
                            <h4><a href="blog-details.html">To Make Your
                                    Smartness & Catch
                                    Your Bright Dream.</a></h4>
                            <div class="explore-btn">
                                <a href="blog-details.html"><span><img
                                            src="/assets/images/icon/explore-elliose.svg"
                                            alt
                                        ></span> Explore More</a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="recent-article-wrap">
                        ...
                        <div class="recent-article-content">
                            ...
                            <h4><a href="blog-details.html">Be Confident
                                    Your Dream & Struggle
