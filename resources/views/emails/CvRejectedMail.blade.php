                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        Thank you for your interest in the {{ $jobApplicationData['job_title'] }}</b> at
                                                        <b>{{ $jobApplicationData['company_name'] }}</b> in
                                                        <b>{{ $jobApplicationData['company_location'] }}</b>. We appreciate you taking the time to submit your application and for sharing your skills and experience with us.
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td
                                                        style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                                        After reviewing your CV and other applications, we regret to inform you that yours wasn't selected for further consideration at this time. While your qualifications were impressive, some other candidates' profiles aligned more closely with the specific requirements.
