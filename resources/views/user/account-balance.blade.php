    ...
    <div class="auto-container">
        ...
        <ul class="order-info">
            <li>
                ...
                <strong>{{ $user->account_balance }}</strong>
            </li>
        ...
        <div class="upper-box">
            <h4>Make Deposit</h4>
            <div class="text">Make deposit to the account to the Wallet addresses below and send screeenshot to <a href="mailto:support@travel-plan.agency">support@travel-plan.agency.</a>for confirmation Purposes</div>
        </div>
        -->
