...
<x-main-pages.layout>
    ...
    @slot('mainHeader')
        <x-main-pages.header class="header-style-one" />
    ...
    $secBtnUrl = "https://travel-plan.agency/visa-apply";
    ...
    @php
        ...
        $section = [
            ...
            'btnUrl' => 'https://travel-plan.agency/contact-us',
    ...
    @php
        ...
        $section = [
            ...
            'texts' => [
                'Navigating the complexities of UK immigration law and visa applications can be a confusing process without the right help. Whatever the nature of your case, Travel Plans’ immigration lawyers are ready to take this stressful burden away from you and your family.',
            ],
        ];
    @endphp
    ...
    @php
        ...
        $section = [
            'title' => 'Why hire one of Travel Plans’ lawyers?',
            'texts' => [
    ...
    $section = [
        'title' => 'How can Travel Plan help me and my family?',
        'texts' => [
