...
Route::middleware([
    ...
    //admin.users.update
    Route::put('/admin/users/{user}/update', [\App\Http\Controllers\AdminController::class, 'usersUpdate'])->name('admin.users.update');

    //admin.users.update-balance
    Route::put('/admin/users/{user}/update-balance', [\App\Http\Controllers\AdminController::class, 'usersUpdateBalance'])->name('admin.users.update-balance');
